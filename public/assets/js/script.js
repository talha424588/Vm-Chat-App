                    ...
                    switch (message.type) {
                        ...
                        case "File":
                            ...
                            if (fileNameElement) {
                                ...
                                const index = fileName.toLowerCase().indexOf(DOM.messageSearchQuery);
                                if (index !== -1) {
...
searchMessageInputFeild.addEventListener("input", function (e) {
    if (e.target.value.length > 0) {
        DOM.messageSearchQuery = e.target.value.length;
        clearTimeout(debounceTimeout);
        debounceTimeout = setTimeout(async function () {
                        ...
                        messageResponse.messages.forEach((message) => {
                            ...
                            resultItemDiv.addEventListener("click", function () {
                                ...
                                if (messageElement) {
                                    ...
                                    console.log("else part", currentPage);;
                                    console.log('pagniated array message count', pagnicateChatList.data.length)
